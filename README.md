...
## 🚀 Продвинутые возможности (Advanced BI)

### 📊 Сложная визуализация
- **Multi-line Chart:** Динамическое сравнение выручки по нескольким категориям одновременно.
- **Custom RPC:** Использование собственной SQL-функции `monthly_sales_by_category` для глубокой аналитики.

### 🤖 AI-Ассистент (Gemini 3 Flash)
- **Natural Language Queries:** Задавайте вопросы на естественном языке (например, "Сравни продажи электроники и одежды").
- **Tool Calling:** ИИ самостоятельно выбирает нужные функции для получения актуальных данных из базы Supabase.
- **Автоматическая визуализация:** Ассистент строит сложные Multi-line графики прямо в чате.
